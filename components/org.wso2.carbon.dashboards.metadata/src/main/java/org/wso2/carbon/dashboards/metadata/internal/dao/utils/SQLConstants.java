...
public class SQLConstants {
    ...
    public static final String UPDATE_METADATA_QUERY = "UPDATE DASHBOARD_RESOURCE SET DASHBOARD_NAME = ?, " +
            "DASHBOARD_DESCRIPTION = ?,DASHBOARD_UPDATEDBY= ?, " +
            "DASHBOARD_SHARED = ?, DASHBOARD_LAST_UPDATED = ?, DASHBOARD_CONTENT = ? WHERE DASHBOARD_URL = ? "
            + "AND DASHBOARD_VERSION = ? AND DASHBOARD_OWNER = ?";

    public static final String GET_METADATA_QUERY =
            "SELECT DASHBOARD_ID, DASHBOARD_URL, DASHBOARD_NAME, DASHBOARD_VERSION, " +
    ...
    public static final String GET_METADATA_BY_URL =
            "SELECT DASHBOARD_ID, DASHBOARD_URL, DASHBOARD_NAME, DASHBOARD_VERSION, " +
                    "DASHBOARD_OWNER, DASHBOARD_UPDATEDBY, DASHBOARD_DESCRIPTION, DASHBOARD_SHARED, DASHBOARD_PARENT_ID,"
                    +
                    " DASHBOARD_CREATED_TIME,DASHBOARD_LAST_UPDATED, DASHBOARD_CONTENT FROM DASHBOARD_RESOURCE " +
    ...
    public static final String GET_METADATA_BY_OWNER_AND_NAME = "SELECT DASHBOARD_ID, DASHBOARD_URL, DASHBOARD_NAME, " +
            "DASHBOARD_VERSION, DASHBOARD_OWNER, DASHBOARD_UPDATEDBY, DASHBOARD_DESCRIPTION, DASHBOARD_SHARED, " +
            "DASHBOARD_PARENT_ID, DASHBOARD_CREATED_TIME,DASHBOARD_LAST_UPDATED, DASHBOARD_CONTENT " +
            "FROM DASHBOARD_RESOURCE WHERE DASHBOARD_OWNER = ? AND DASHBOARD_NAME = ?";

    public static final String GET_METADATA_BY_NAME =
            "SELECT DASHBOARD_ID, DASHBOARD_URL, DASHBOARD_NAME, DASHBOARD_VERSION, " +
                    "DASHBOARD_OWNER, DASHBOARD_UPDATEDBY, DASHBOARD_DESCRIPTION, DASHBOARD_SHARED, DASHBOARD_PARENT_ID,"
                    +
    ...
    public static final String DELETE_METADATA_QUERY =
            "DELETE FROM DASHBOARD_RESOURCE WHERE DASHBOARD_OWNER = ? " + "AND DASHBOARD_URL = ?";

    public static final String DELETE_METADATA_URL = "DELETE FROM DASHBOARD_RESOURCE WHERE DASHBOARD_URL = ?";

    public static final String LIST_METADATA_QUERY =
            "SELECT DASHBOARD_ID, DASHBOARD_URL, DASHBOARD_NAME, DASHBOARD_VERSION, " +
                    "DASHBOARD_OWNER, DASHBOARD_UPDATEDBY, DASHBOARD_DESCRIPTION, DASHBOARD_SHARED, DASHBOARD_PARENT_ID, "
                    +
                    "DASHBOARD_CREATED_TIME,DASHBOARD_LAST_UPDATED, DASHBOARD_CONTENT FROM DASHBOARD_RESOURCE";

    public static final String GET_METADATA_BY_URL_AND_VERSION =
            "SELECT DASHBOARD_ID, DASHBOARD_URL, DASHBOARD_NAME, " +
                    "DASHBOARD_VERSION, DASHBOARD_OWNER, DASHBOARD_UPDATEDBY, DASHBOARD_DESCRIPTION, DASHBOARD_SHARED, "
                    +
                    "DASHBOARD_PARENT_ID, DASHBOARD_CREATED_TIME,DASHBOARD_LAST_UPDATED, DASHBOARD_CONTENT " +
                    "FROM DASHBOARD_RESOURCE WHERE DASHBOARD_URL = ? AND DASHBOARD_VERSION = ?";

    public static final String GET_METADATA_BY_NAME_AND_VERSION =
            "SELECT DASHBOARD_ID, DASHBOARD_URL, DASHBOARD_NAME, " +
                    "DASHBOARD_VERSION, DASHBOARD_OWNER, DASHBOARD_UPDATEDBY, DASHBOARD_DESCRIPTION, DASHBOARD_SHARED, "
                    +
                    "DASHBOARD_PARENT_ID, DASHBOARD_CREATED_TIME,DASHBOARD_LAST_UPDATED, DASHBOARD_CONTENT " +
